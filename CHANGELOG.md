...
- Add Horizons 4.0 launch flag to default settings (`/edh4`)
  ...
  Users upgrading from previous versions will need to manually [update] their [settings.json] or delete it and let it be autogenerated to include the new flag
### Misc
